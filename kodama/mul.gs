...
*                           [-xini value] [-xwid value] [-xint value]
*                           [-yini value] [-ywid value] [-yint value]
...
*     xini,yini : lower-left position when "mul ? ? 1 1"
*     xwid,ywid : width of figure
*     xint,yint : interval of figures
* note:
