...
*** var, min, max
      if( var!='none' & vmin!='none' & vmax='none' ); vmax=arg; break; endif
      if( var!='none' & vmin='none' ); vmin=arg; break; endif
      if( var='none' ); var=arg; break; endif
...
function help()
  ...
  say ' '
  say ' Usage:'
  say '   hatch var ( min max | -min min | -max max ) [-angle angle] [-density density] [-int int]'
  say ' '
  say '     var         : variable'
