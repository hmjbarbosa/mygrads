*hmjb 
* Like cbar_line2 but demands an option -w for the linewidths and
* the lines are only drawn if linestyle is not equal to zero. It turns
* off the string size definition, so the user can modify this outside. 
* This version will draw the legend on a line.
* 
...
if (k!=m | k!=l | k!=t | k!=w | m!=l | m!=t | m!=w | l!=t | l!=w )
   say '# of widths, colors, marks, lines and/or text not equal.'
   say '# colors 'k
   say '# marks  'm
   say '# lines  'l
   say '# texts  't
...
* keep sizes defined outside
*'set strsiz 0.12 0.13'

o=0
while (o<maximum)
  o=o+1
  'set line 'cols.o' 'lines.o' 'widths.o
  if (lines.o!=0) 
  ...
  xl=xl+xwid+widths.o+0.1
  xr=xr+xwid+widths.o+0.1
endwhile
